...
public class LoggingAspect {
    ...
    public void logMethodExit(@NotNull JoinPoint joinPoint, Object result) {
        log.info("Exiting method: {}. Returned: {}", joinPoint.getSignature().toShortString(), result);
    }
    ...
    public Object logExecutionTime(@NotNull ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        log.info("Execution time of {} took {} ms", joinPoint.getSignature().toShortString(), (endTime - startTime));
        return proceed;
    }
